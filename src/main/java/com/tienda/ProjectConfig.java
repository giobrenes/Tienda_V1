    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/", "/index", "/errores/**",
                        ...
                        "/registro/**", "/js/**", "/webjars/**")
                .permitAll() //todos los roles van a tener acceso a las vistas que estan arriba (anteriores filas a esta)
                .requestMatchers(
                        ...
                        "/usuario/**",
                        "/reportes/**"
                ).hasRole("ADMIN") //todas las vista anteriores a estas fila
                .requestMatchers(
                        "/producto/listado",
                        "/categoria/listado",
                        "/pruebas/**",
